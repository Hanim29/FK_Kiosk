...
@section('content')
    <div class="container">
        <h2 class="text-center mb-4 text-uppercase">add sales</h2>
        <div class="p-4 mb-3" id="addSaleForm">
            <div class="row" >
                <form method="POST" action="{{  route('sales.add.perform')  }}">
                    @csrf
                    {{-- hidden input fiels --}}
                    <input type="text" class="form-control" name="userID" value={{ Auth::user()->id }} required hidden>
                    <input type="date" class="form-control" name="saleDate" value="{{ date('Y-m-d') }}" required hidden>
                    ...
                    <div class="col-md-6 mx-auto">
                        ...
                        <div class="form-group row mb-3">
                            <label for="application_number" class="col-sm-4 col-form-label text-end">Total of KIOSK</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="totalOfKiosk" required>
                            </div>
                        </div>
