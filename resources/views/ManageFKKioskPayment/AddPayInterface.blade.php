...
@section('content')
    <div class="container">
        ...
        <form class="p-4 mb-3" id="paymentForm" method="POST" action="{{ route('payments.perform') }}">
            @csrf
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="application_number" name="appID" value={{ $userApplication->appID }} required >
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="phone_number" name="phoneNum" value="{{  Auth::user()->phone_num }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="datetime-local" class="form-control" id="date_of_payment" name="payDate" value="{{ \Carbon\Carbon::now()->format('Y-m-d\TH:i') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="kiosk_number" name="kioskNum" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="total_payment" name="totalPay" required>
                        </div>
                    </div>
        ...
        {{-- overlay to show payment sucessful --}}
