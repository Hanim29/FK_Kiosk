                ...
                <form method="post" action="{{ route('create_user') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="matrix_id" id="matrix_id" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                        </div>

                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="phone_num" class="block font-medium text-sm text-gray-700">Phone Number</label>
                            <input type="text" name="phone_num" id="phone_num" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                        </div>

                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="ic_number" class="block font-medium text-sm text-gray-700">IC Number</label>
                            <input type="text" name="ic_number" id="ic_number" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                        </div>
